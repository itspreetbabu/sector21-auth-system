# sector21-auth-system
A secure role-based agent authorization system built with Python and MySQL, featuring multi-layer authentication, admin controls, and a helpdesk interface.
